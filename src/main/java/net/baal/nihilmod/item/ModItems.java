...
import net.baal.nihilmod.item.custom.MetalDetectorItem;
...
public class ModItems {
    ...
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, NihilMod.MOD_ID);
