package net.baal.nihilmod.block;

import net.baal.nihilmod.NihilMod;
import net.baal.nihilmod.block.custom.SoundBlock;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, NihilMod.MOD_ID);
